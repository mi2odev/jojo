...
const en: UIStrings = {
  ...
  howItWorksDesc: 'Answer 24 cinematic scenarios crafted to map your choices onto the core spirit of each JoJo protagonist.',
...
const ar: UIStrings = {
  ...
  howItWorks: 'كيف يعمل',
  howItWorksDesc: 'أجب عن ٢٤ موقفاً سينمائياً صُمّمت لربط اختياراتك بروح كل بطل من أبطال جوجو.',
